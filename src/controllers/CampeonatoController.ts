...
export class CampeonatoController {
    ...
    async store(req: Request, res: Response, next: NextFunction) {
        try {
            const novoCampeonato = await this.CampeonatoService.criarCampeonato(req.body);
    ...
    async update(req: Request, res: Response, next: NextFunction) {
        try {
            const { id } = req.params;
            const atualizado = await this.CampeonatoService.atualizarCampeonato(String(id), req.body);
    ...
    async inscreverClube(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const novaInscricao = await this.CampeonatoService.inscreverClube(String(id_campeonato), String(id_clube));
