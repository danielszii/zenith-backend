...
export class CreateUsuarioDTO {
  ...
  @IsEmail({}, { message: 'O e-mail fornecido deve ser um endereço de e-mail válido.' })
  ...
  @IsIn(['admin', 'mesario', 'gestor'], { 
    message: 'A role fornecida é inválida. Os valores aceitos são: admin, mesario ou gestor.' 
  })
